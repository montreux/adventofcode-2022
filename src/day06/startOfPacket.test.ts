...
test("Part 1 - Test Case", () => {
  ...
  expect(startOfPacket).not.toBe(0);

  console.log(`First position after start of packet: ${startOfPacket}`);
});
...
test("Part 2 - Test Case", () => {
  ...
  console.log(`First position after start of message: ${startOfPacket}`);
});
